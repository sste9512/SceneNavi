...
namespace SceneNavi.ROMHandler
{
    public class SceneTableEntryOcarina : ISceneTableEntry
    {
        ...
        {
            return
                (sceneStartAddress < _baseRom.Rom.Size) && (sceneEndAddress < _baseRom.Rom.Size) && (LabelStartAddress < _baseRom.Rom.Size) && (LabelEndAddress < _baseRom.Rom.Size) &&
        ...
        public SceneTableEntryOcarina(BaseRomHandler baseRom, int ofs, bool isrel)
        {
            ...
            sceneStartAddress = Endian.SwapUInt32(BitConverter.ToUInt32(IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data, ofs));
            sceneEndAddress = Endian.SwapUInt32(BitConverter.ToUInt32(IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data, ofs + 4));

            LabelStartAddress = Endian.SwapUInt32(BitConverter.ToUInt32(IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data, ofs + 8));
            LabelEndAddress = Endian.SwapUInt32(BitConverter.ToUInt32(IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data, ofs + 12));
            Unknown1 = (IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data)[ofs + 16];
            ConfigurationNo = (IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data)[ofs + 17];
            Unknown3 = (IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data)[ofs + 18];
            Unknown4 = (IsOffsetRelative ? baseRom.Rom.CodeData : baseRom.Rom.Data)[ofs + 19];
        ...
        public void SaveTableEntry()
        {
            ...
            Buffer.BlockCopy(tmpbuf, 0, (IsOffsetRelative ? _baseRom.Rom.CodeData : _baseRom.Rom.Data), Offset + 8, tmpbuf.Length);
            ...
            (IsOffsetRelative ? _baseRom.Rom.CodeData : _baseRom.Rom.Data)[Offset + 16] = Unknown1;
            (IsOffsetRelative ? _baseRom.Rom.CodeData : _baseRom.Rom.Data)[Offset + 17] = ConfigurationNo;
            (IsOffsetRelative ? _baseRom.Rom.CodeData : _baseRom.Rom.Data)[Offset + 18] = Unknown3;
            (IsOffsetRelative ? _baseRom.Rom.CodeData : _baseRom.Rom.Data)[Offset + 19] = Unknown4;
        }
